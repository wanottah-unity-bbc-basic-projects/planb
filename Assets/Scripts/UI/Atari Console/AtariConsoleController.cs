...
public class AtariConsoleController : MonoBehaviour
{
    ...
    // reference to atari console game object
    [SerializeField] private GameObject atariConsole = null;
    ...
    [SerializeField] private Button leftDifficultySwitch;
    [SerializeField] private Button rightDifficultySwitch;

    [SerializeField] private Button audioSelectionSwitch;
    ...
    [SerializeField] private Button gamePawzSwitch = null;
    ...
    public void SetConsoleMode(int consoleMode)
    {
        switch (consoleMode)
        {
            case CONSOLE_VISIBLE:
                ...
                atariConsole.GetComponent<Animator>().SetBool("consoleMode", true);

                break;

            case CONSOLE_HIDDEN:

                atariConsole.GetComponent<Animator>().SetBool("consoleMode", false);
    ...
    {
        gameController.gameCredits = gameController.gameCredits + 1;
        ...
        switch (difficultySetting)
        {
            case DIFFICULTY_A:
                ...
                if (leftSwitch)
                {
                    ...
                    // change sprite size for player 1
                ...
                else
                {
                    ...
                    // change sprite size for player 2
    ...
    public void GameNumberSelectionSwitch()
    {
        ...
        {
            gameNumberSelected = gameNumberSelected + 1;
    ...
    {
        audioModeSelected = audioModeSelected + 1;
